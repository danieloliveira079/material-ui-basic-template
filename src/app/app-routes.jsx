...
var Visita = require('./components/pages/visita.jsx');
var Assunto = require('./components/pages/assunto.jsx');
...
var AppRoutes = (
  <Route name="root" path="/" handler={Master}>
    ...
    <Route name="visita" handler={Visita} />
    <Route name="assunto" handler={Assunto} />
